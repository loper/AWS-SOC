...
def resize_thumbnail(thumbnail, quality=70):
...
web-content/m/{}?srcx=0&type=1&srcmode=1&quality={}&\
dstw={}&dsth={}""".format(thumb, quality, dstw, dsth)
    return img
...
def create_row(data):
    ...
    output = {}
    try:
        output[0] = (data['asset_id'], data['id'], int(data['id'])+1)
